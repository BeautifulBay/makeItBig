...
class ParseSubtitle():
    ...
    def transferFileEncode(self, filePath, fromCode, toCode):
        ...
        wFile = open(filePath, 'w', encoding='utf-8')
        if fromCode == 'gb2312':
    ...
    def parseSubtitle(self):
        def parseASS(self):
            with open(self.subtitle, 'r', encoding='utf-8') as mFile:
                with open(self.savefile1, 'w', encoding='utf-8') as sFile1:
                    with open(self.savefile2, 'w', encoding='utf-8') as sFile2:
                        with open(self.savefile3, 'w', encoding='utf-8') as sFile3:
                            with open(self.savefile4, 'w', encoding='utf-8') as sFile4:
